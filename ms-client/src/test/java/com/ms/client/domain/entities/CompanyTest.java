...
public class CompanyTest {
	...
	@Test
	@DisplayName("should throw an exception when create a company with email")
	void testCreateUserManagerWithEmail() {
		Exception exception = assertThrows(IncorrectValueException.class, () -> {
			new Company(
			  "4ff6d786-b7a1-4efc-be85-a297e04c2f48",
			  "any corporate name",
	...
	@Test
	@DisplayName("should throw an exception when create a company with empty phone")
	void testCreateCompanyWithEmptyPhone() {
		Exception exception = assertThrows(IncorrectValueException.class, () -> {
			new Company(
			  "4ff6d786-b7a1-4efc-be85-a297e04c2f48",
			  "any corporate name",
	...
	@Test
	@DisplayName("should throw an exception when create a company with incorrect phone format")
	void testCreateCompanyWithIncorrectPhoneFormat() {
		Exception exception = assertThrows(FormatException.class, () -> {
			new Company(
			  "4ff6d786-b7a1-4efc-be85-a297e04c2f48",
			  "any corporate name",
