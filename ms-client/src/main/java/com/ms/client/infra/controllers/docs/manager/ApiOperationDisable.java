...
@Operation(summary = "Disable manager", description = "Returns the manager disabled", tags = {"Manager"})
@ApiResponses({
  @ApiResponse(responseCode = "200", description = "The manager was disabled", content = @Content(
...
public @interface ApiOperationDisable {}
