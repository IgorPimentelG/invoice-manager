...
@Operation(summary = "Update company", description = "Returns the company updated", tags = {"Company"})
@ApiResponses({
  @ApiResponse(responseCode = "200", description = "The company was updated", content = @Content(
