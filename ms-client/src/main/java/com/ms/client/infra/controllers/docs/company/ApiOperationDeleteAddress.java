...
@Operation(summary = "Delete company address", description = "Returns the company updated", tags = {"Company"})
@ApiResponses({
  @ApiResponse(responseCode = "200", description = "The address was deleted", content = @Content(
  ...
  @ApiResponse(responseCode = "423", description = "The address cannot be deleted", content = @Content(
	schema = @Schema(implementation = LockedException.class)
  ))
})
public @interface ApiOperationDeleteAddress {}
