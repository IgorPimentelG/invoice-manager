...
@Operation(summary = "Register a company", description = "Returns the company created", tags = {"Company"})
@ApiResponses({
  @ApiResponse(responseCode = "200", description = "The company was created", content = @Content(
